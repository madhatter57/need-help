...
public:
  ...
  //static const stattype BASESPOINTS = (stattype)1u;
...
public:
  ...
  //static const stattype BASESPOINTS = (stattype)0u;
...
public:
  ...
  static const welltype BASEMP = (welltype)1u;
...
class Necromancer : public PlayerCharacterDelegate {
public:
  static const welltype BASEHP = (welltype)6u;
  static const welltype BASEMP = (welltype)20u;
  static const stattype BASESTR = (stattype)3u;
  static const stattype BASEINT = (stattype)3u;
  static const stattype BASEAGI = (stattype)3u;
  //static const stattype BASESPOINTS = (stattype)0u;
  std::string getClassName() override { return std::string("Necromancer"); }
  Necromancer() : PlayerCharacterDelegate() {
    MP = std::make_unique<PointWell>(BASEMP, BASEMP);  // be sure to init before PCCONSTRUCT MACRO
    PCCONSTRUCT
...
private:
  void LevelUp() override {
    LEVELUP
      if (CurrentLevel == 2) {
        Abilities.emplace_back("Raise skeleton", 0u, 3u, ABILITYTARGET::ENEMY, 6u, ABILITYSCALER::AGI);
      }
  }
};
...
public:
 ...
 welltype getCurrentMP() {
  ...
  //stattype getSkillPoints() { return pcclass->getSkillPoints(); }
